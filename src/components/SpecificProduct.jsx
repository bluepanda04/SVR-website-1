...
const ProductInformation = {
  ...
  cartesian: {
    title: "SVR Robotics leverages Cartesian Robots for diverse applications such as pick-and-place tasks, assembly operations, and material handling, ensuring flexibility across various industries.",
    image: ["path1", "path2", "path3"],
